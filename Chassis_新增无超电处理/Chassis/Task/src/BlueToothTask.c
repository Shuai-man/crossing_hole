...
void BlueToothTask(void const * argument)
{
  ...
  while (1)
  {
    ...
    // 功率拟合
  //  data.fdata[0] = infantry.power_limiter.sum_i_2_collect;
		data.fdata[0] = infantry.power_limiter.I_collect[0];
    data.fdata[1] = infantry.power_limiter.sum_w_i_collect;
    data.fdata[2] = cap_recv_data.chassis_power / 100.0f;
    data.fdata[3] = infantry.power_limiter.sum_w_2;
    data.fdata[4] = cap_recv_data.referee_power / 100.0f;
		data.fdata[5] = infantry.power_limiter.now_power_predict;
	//电容测试
//	 data.fdata[0] = cap_recv_data.cap_vol / 100.0f;
//	 data.fdata[1] = cap_recv_data.chassis_power / 100.0f;
//	 data.fdata[2] = cap_recv_data.referee_power / 100.0f;
...
//    data.fdata[0] = cap_recv_data.chassis_power / 100.0f;
