...
void CanReceiveAll(CAN_HandleTypeDef *hcan, CAN_RxHeaderTypeDef *rx_header, uint8_t *data)
{
    if (hcan == DJI_WHEELS_CAN)
    {
        ...
        case DJI_3508_MOTORS_1:
            ...
            LossUpdate(&global_debugger.wheels_comm_debugger[0], DJI_WHEELS_LOSS_TIME);
            break;
        case DJI_3508_MOTORS_2:
            ...
            LossUpdate(&global_debugger.wheels_comm_debugger[1], DJI_WHEELS_LOSS_TIME);
            break;
        case DJI_3508_MOTORS_3:
            ...
            LossUpdate(&global_debugger.wheels_comm_debugger[2], DJI_WHEELS_LOSS_TIME);
            break;
        case DJI_3508_MOTORS_4:
            ...
            LossUpdate(&global_debugger.wheels_comm_debugger[3], DJI_WHEELS_LOSS_TIME);
            break;
        default:
            break;
        }
    ...
    if (hcan == DJI_STEERS_CAN)
    {
        ...
        case DJI_6020_MOTORS_1:
            ...
            LossUpdate(&global_debugger.steers_comm_debugger[0], DJI_STEERS_LOSS_TIME);
            break;
        case DJI_6020_MOTORS_2:
            ...
            LossUpdate(&global_debugger.steers_comm_debugger[1], DJI_STEERS_LOSS_TIME);
            break;
        case DJI_6020_MOTORS_3:
            ...
            LossUpdate(&global_debugger.steers_comm_debugger[2], DJI_STEERS_LOSS_TIME);
            break;
        case DJI_6020_MOTORS_4:
            ...
            LossUpdate(&global_debugger.steers_comm_debugger[3], DJI_STEERS_LOSS_TIME);
            break;
        default:
            break;
        }
    ...
    if (hcan == GIMBAL_CAN_COMM_CANx)
    {
        ...
        case GIMBAL_COMM_CAN_ID_1:
            ...
            LossUpdate(&global_debugger.gimbal_comm_debugger[0], GIMBAL_LOSS_TIME);
            break;
        case GIMBAL_COMM_CAN_ID_2:
            memcpy(&gimbal_receiver_pack2, data, 8);
            LossUpdate(&global_debugger.gimbal_comm_debugger[1], GIMBAL_LOSS_TIME);
            break;
        default:
            break;
        }
