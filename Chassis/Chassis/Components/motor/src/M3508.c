...
void M3508_Decode(M3508_Recv *M3508_recv, M3508_Info *M3508_decoded, int8_t decode_type, float filte_value)
{
    ...
    else if (decode_type == ONLY_SPEED_WITHOUT_FILTER_WITH_REDU)
    {
        M3508_decoded->speed = M3508_recv->speed * M3508_SPEED_RATIO / M3508_REDUCTION_RATIO;
        M3508_decoded->torque_current = M3508_recv->torque_current / C620_CURRENT_SEND_TRANS;
    }
}
 ...
 */
void M3508_SendPack(uint8_t *can_data, uint32_t std_id, uint8_t motor_id, float control_current, enum SEND_TYPE send_type)
{
