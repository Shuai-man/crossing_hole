...
#define CHASSIS_LOSS_TIME	0.006f //s
#define CHASSIS_CAN_COMM_CANx &hcan1

/*---------CAN1------------*/
// FIFO 0 接收ID
#define CAN1_FIFO0_ID0 YAW_MOTOR_MASTER_CAN_ID
#define CAN1_FIFO0_ID1 LIFT_MOTOR_CAN_ID
#define CAN1_FIFO0_ID2 TOGGLE_MOTOR_CAN_ID
#define CAN1_FIFO0_ID3 0x000

// FIFO 1 接收ID
#define CAN1_FIFO1_ID0 GET_FROM_CHASSIS_CAN_ID_1
#define CAN1_FIFO1_ID1 GET_FROM_CHASSIS_CAN_ID_2
#define CAN1_FIFO1_ID2 ENCODER_ID
#define CAN1_FIFO1_ID3 0x003

/*---------CAN2------------*/
// FIFO 0 接收ID
#define CAN2_FIFO0_ID0 PITCH_MOTOR_MASTER_CAN_ID
#define CAN2_FIFO0_ID1 0x001
#define CAN2_FIFO0_ID2 0x004
#define CAN2_FIFO0_ID3 0x000

// FIFO 1 接收ID
#define CAN2_FIFO1_ID0 RIGHT_FRICTION_WHEEL_CAN_ID
#define CAN2_FIFO1_ID1 LEFT_FRICTION_WHEEL_CAN_ID
#define CAN2_FIFO1_ID2 0x003
